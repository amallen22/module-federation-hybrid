    ...
    <div className={styles.page}>
      ...
      >
        <div className={styles.timelineSection}>
          <h4>Fase 1: Desbloqueo del Stack (6-7 semanas)</h4>
          <ul>
            <li>Completar UI Kit: 2-3 semanas</li>
          ...
          <h4>Fase 2: Desacoplamiento Legacy (14-16 semanas)</h4>
          <ul>
            <li>cv-app-login: Migración base completada, TanStack Query en progreso</li>
            <li>cv-app-user: 4-5 semanas</li>
            <li>cv-lib-app-components: 3-4 semanas (paralelo con user)</li>
            <li>cv-app-shop: 2-3 semanas</li>
            <li>cv-app-payment: 2 semanas</li>
            <li>cv-app-share: 1 semana</li>
            <li>Shell updates: 1 semana (distribuido)</li>
            <li>Buffer: +2 semanas</li>
          </ul>

          <h4>Fase 3: Editor Refactoring (15-18 semanas)</h4>
          <ul>
            <li>Jest → Vitest: 2 semanas</li>
            <li>Setup y preparación: 2 semanas</li>
            <li>Migración Redux → Zustand + TanStack Query: 3-4 semanas</li>
            <li>Migración componentes con TDD: 6-8 semanas</li>
        ...
        <div className={styles.totalBox}>
          ...
          <div className={styles.totalValues}>
            <div className={styles.scenario}>
              ...
              <span className={styles.scenarioValue}>33 semanas (~8 meses)</span>
            </div>
            <div className={styles.scenario}>
              <span className={styles.scenarioLabel}>Realista:</span>
              <span className={styles.scenarioValue}>40 semanas (~10 meses)</span>
            </div>
            <div className={styles.scenario}>
              <span className={styles.scenarioLabel}>Pesimista:</span>
              <span className={styles.scenarioValue}>48 semanas (~12 meses)</span>
            </div>
          </div>
        </div>
      </PhaseCard>
      ...
      >
        <div className={styles.cursorSection}>
          ...
          <ul>
            <li><strong>UI Kit:</strong> 1-1.5 semanas
              <ul>
          ...
          <h4>Fase 2: Desacoplamiento Legacy (6-8 semanas) ⚡️</h4>
          <ul>
            <li><strong>cv-app-user:</strong> 2-2.5 semanas
              <ul>
                ...
                <li>Convierte PropTypes a TypeScript interfaces</li>
                <li>Migra estilos MUI a Sass con un prompt</li>
              </ul>
            </li>
            <li><strong>cv-app-shop:</strong> 1-1.5 semanas</li>
            <li><strong>cv-app-payment:</strong> 1 semana</li>
            <li><strong>cv-app-share:</strong> 3-4 días</li>
            <li><strong>cv-lib-app-components:</strong> 1.5-2 semanas (paralelo)</li>
          </ul>

          <h4>Fase 3: Editor Refactoring (6-9 semanas) ⚡️</h4>
          <ul>
            <li><strong>Jest → Vitest:</strong> 3-4 días
              <ul>
                <li>Cursor convierte tests automáticamente</li>
                <li>Actualiza syntax y mocks instantáneamente</li>
              </ul>
            </li>
            <li><strong>Migración Redux → Zustand:</strong> 1.5-2 semanas
              <ul>
                <li>Cursor identifica patrones y genera stores Zustand</li>
                <li>Separa automáticamente server state vs client state</li>
              </ul>
            </li>
            <li><strong>Migración componentes:</strong> 3-4 semanas
              <ul>
            ...
            <li><strong>Integración:</strong> 1 semana</li>
          </ul>
        </div>
        ...
        <div className={`${styles.totalBox} ${styles.cursorTotal}`}>
          ...
          <div className={styles.totalValues}>
            <div className={styles.scenario}>
              <span className={styles.scenarioLabel}>Optimista:</span>
              <span className={styles.scenarioValue}>15 semanas (~4 meses)</span>
            </div>
            <div className={styles.scenario}>
              <span className={styles.scenarioLabel}>Realista:</span>
              <span className={styles.scenarioValue}>20 semanas (~5 meses)</span>
            </div>
            <div className={styles.scenario}>
              <span className={styles.scenarioLabel}>Pesimista:</span>
              <span className={styles.scenarioValue}>24 semanas (~6 meses)</span>
            </div>
          </div>
          <div className={styles.savings}>
            💰 Ahorro de tiempo: <strong>16-24 semanas</strong> (4-6 meses)
          </div>
        </div>
        ...
        <div className={styles.benefitsGrid}>
          <div className={styles.benefit}>
            ...
            <h5>Velocidad</h5>
            <p>Generación de código 10x más rápida</p>
          </div>
          <div className={styles.benefit}>
            <span className={styles.benefitIcon}>🎯</span>
            <h5>Precisión</h5>
            <p>Menos errores humanos en refactoring</p>
          </div>
          <div className={styles.benefit}>
            <span className={styles.benefitIcon}>📚</span>
            <h5>Conocimiento</h5>
            <p>IA conoce best practices actualizadas</p>
          </div>
          <div className={styles.benefit}>
            <span className={styles.benefitIcon}>🔄</span>
            <h5>Iteración</h5>
            <p>Feedback loops instantáneos</p>
          </div>
        </div>
      </PhaseCard>
